...
MODELREF_LINK_RSPFILE     = ABS_Controller_ref.rsp
COMPILER_COMMAND_FILE     = ABS_Controller_comp.rsp
CMD_FILE                  = ABS_Controller.rsp
...
DEFINES_BUILD_ARGS = -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTERMFCN=1 -DONESTEPFCN=0 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0
DEFINES_CUSTOM = 
...
DEFINES_STANDARD = -DMODEL=ABS_Controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
MODELREF_LIBS = D:/Personal/Work/Projects/Github/ABS-SIL-Controller/slprj/ert/ABS_Controller/ABS_Controller_rtwlib.lib

LIBS = $(START_DIR)/slprj/ert/ABS_Controller/coderassumptions/lib/ABS_Controller_ca.lib
...
xil_interface.obj : $(START_DIR)/slprj/ert/ABS_Controller/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/slprj/ert/ABS_Controller/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
