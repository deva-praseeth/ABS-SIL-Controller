/*
 * ABS_Controller_ssf.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: ABS_Controller
 * Component Simulink Path: ABS_Controller
 * Simulation Mode: SIL
 *
 */

#define S_FUNCTION_NAME                ABS_Controller_ssf
...
static RegMdlInfo rtMdlInfo_ABS_Controller[1] = { "",
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("ABS_Controller");
      mxArray *rhs[3];
      char * simulinkBlockPath = getSimulinkBlockPath(S);
      if (simulinkBlockPath == NULL) {
        ssSetErrorStatus(S,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (S->mdlInfo->genericFcn != (NULL) &&
    ...
    ssRegModelRefMdlInfo(S, (char *)"ABS_Controller", rtMdlInfo_ABS_Controller,
                         1);
  }
