 ...
 *
 * SIL generated interface for code: "ABS_Controller"
 *
 */
...
/* interface data */
real_T i_DriverInput;

/* interface data */
real_T o_BrakingTorque;
...
/* interface data */
MdlrefDW_ABS_Controller_T ABS_Controller_MdlrefDW;

/* interface (pointer) data */
RT_MODEL_ABS_Controller_T * RTModel_ptr = &(ABS_Controller_MdlrefDW.rtm);
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  if (xilFcnId == 0) {
    ...
    ABS_Controller_initialize(rt_errorStatus, RTModel_ptr);
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(i_DriverInput);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    /* Call all Set class methods */
    ABS_Controller(&(i_slip), &(i_vF), &(i_DriverInput), &(o_BrakingTorque),
                   &(ABS_Controller_MdlrefDW.rtdw));
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(o_BrakingTorque);
